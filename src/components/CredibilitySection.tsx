  ...
  return (
    <div className="w-full max-w-6xl mx-auto px-4 flex flex-col justify-center pointer-events-auto">
      <div className="text-center mb-6 md:mb-8">
        ...
        {/*
          Era "Cada frente, com um caso atrás." — um título que descrevia a
          seção para dentro, contando o que ELA é. Este aponta para fora: os
          cartões abaixo são parcerias que deram fruto, e a única coisa que o
          visitante precisa fazer com essa informação é se ver na próxima.
        */}
        ...
        {CASES.map((c, i) => (
          ...
          >
            ...
            {/*
              ...
              caixa alta e a três centímetros de distância, o que a dobra das
              frentes acabou de dizer — e cobrava do leitor um cruzamento de
              índices ("frente 2 era qual mesmo?") no exato momento em que ele
              deveria estar lendo o resultado. O campo `front` continua em
              cases.ts: o vínculo segue no conteúdo, só não é mais desenhado.
            */}
      ...
      {/*
        Aqui ficava a grade "E o número dá para auditar" — quatro cartões de
        ...
        exigência de apuração continua onde ela morde: cada cartão de caso
        ainda declara a sua `measurement`.
      */}
